...
final class Ocean_Custom_Sidebar {
	...
	public function ocs_setup() {
		...
		if ( 'OceanWP' == $theme->name || 'oceanwp' == $theme->template ) {
			...
			add_action( 'admin_notices', array( $this, 'ocs_install_ocean_notice' ) );
		}
	}
	 ...
	 * @return  void
	 */
	public function ocs_install_ocean_notice() {
		echo '<div class="notice is-dismissible updated">
				<p>' . esc_html__( 'Ocean Custom Sidebar requires that you use OceanWP as your parent theme.', 'ocean-custom-sidebar' ) . ' <a href="https://oceanwp.org/">' . esc_html__( 'Install OceanWP Now', 'ocean-custom-sidebar' ) . '</a></p>
			</div>';
	}
